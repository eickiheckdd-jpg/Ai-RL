...
public class JavaMLP {
    ...
    // Thread-safe inference (local array allocations prevent race conditions)
    ...
    // Combined forward pass + backpropagation step with thread lock
        ...
        for (int l = 0; l < numLayers; l++) {
            ...
            for (int o = 0; o < out; o++) {
                ...
                for (int i = 0; i < in; i++) {
                    ...
                    float mHatW = mWeights[l][wIdx] / beta1T;
                    float vHatW = vWeights[l][wIdx] / beta2T;
