...
public class RLConfig {
    ...
    // Hyperparameters - Stripped down to pure aim
    ...
    public static final float CLIP_EPSILON = 0.2f;
    public static final float LEARNING_RATE = 3e-4f;
    public static final int N_STEPS = 2048;
